        ...
        <div class="row-span-4 col-span-2 grid grid-cols-1 grid-rows-4 ">
            ...
            <div class="col-span-1 col-start-1 bg-white dark:bg-gray-900 rounded-md p-2 row-span-3  ">
                ...
                <div class="grid grid-cols-1 gap-2 h-full justify-center grid-rows-3 ">
                        ...
                        <div class="grid gap-2 justify-center">
                            <div class=" p-2 flex items-center justify-center">
                                <div>
                                    ...
                                    <p>ALIMENTO BEBIBLE A BASE DE EXTRACTO DE SOYA Y LECHE DE VACA FRUTILLA 120 ML - EL
                                        ALTO
                                    </p>
                                    <p>Preparacion:1-2</p>
                        ...
                        <div class="grid gap-2 justify-center">
                            <div class=" p-1 flex items-center justify-center">
                                <div class="text-base">
                                    ...
                                    <P class="text-sm">10083256 - 15 lotes</P>
                                    <p class="text-base">ALIMENTO BEBIBLE A BASE DE EXTRACTO DE SOYA Y LECHE DE VACA FRUTILLA 120 ML - EL
                                        ALTO
                                    </p>
                                    <p class="text-right text-sm">Preparacion:1-2</p>
                                </div>
                    ...
                    {{-- R3 --}}
                    <div class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 row-start-3 row-span-1 col-span-1">
                        <div class=" flex  justify-between  bg-red-500 h-max">
                            <div>
                        ...
                        <div class="grid gap-2 justify-center bg-yellow-500">
                            <div class=" p-2 flex items-center justify-center">
                                <div>
                        ...
                        <div class="flex gap-1 px-0 py-0 w-full justify-between bg-green-500 mb-1">
                            a
                        </div>
