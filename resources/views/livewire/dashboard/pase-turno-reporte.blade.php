<div class="">
    ...
    <div
        class="h-[calc(100vh-110px)] overflow-auto grid grid-cols-[repeat(14,minmax(0,1fr))] grid-rows-[repeat(4,minmax(0,1fr))]  text-2xs">
        {{-- Columna 1 --}}
        <div class="row-span-4 col-span-2 grid grid-cols-1 grid-rows-4 ">
            ...
            {{-- TK NEW --}}
            <div class="col-span-1 col-start-1 bg-white dark:bg-gray-900 rounded-md p-2 row-span-1  row-start-4 ">
        ...
        <div class="row-span-4 col-span-10 grid grid-cols-5 grid-rows-4 ">
            {{-- mixes --}}
            <div class="col-span-4 col-start-1 bg-white dark:bg-gray-900 rounded-md p-2 row-span-1  ">
            ...
            <div class="col-span-1 bg-white dark:bg-gray-900 rounded-md p-2 row-span-1 col-start-5  ">
            ...
            <div class="col-span-4 col-start-1 grid grid-cols-2 ">
                ...
                {{-- sc cc  --}}
                <div
                    class="grid grid-cols-2 gap-2 h-full justify-center grid-rows-1 col-span-1 col-start-2 rounded bg-white dark:bg-gray-900 p-2 ">
                    {{-- SC --}}
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 col-start-1 row-span-1 col-span-1">
                        {{-- cabecera --}}
            ...
            <div class="col-span-5 col-start-1 grid grid-cols-10   ">
                {{-- htst  --}}
                <div
                    class="grid grid-cols-1 gap-2 h-full justify-center grid-rows-1 col-span-5  bg-white dark:bg-gray-900 p-2 rounded ">
                    {{-- HTST --}}
                    <div
                ...
                {{-- arana vasos  --}}
                <div
                    class="grid grid-cols-1 gap-2 h-full justify-center grid-rows-1 col-span-2 col-start-6  bg-white dark:bg-gray-900 p-2    rounded ">
                    {{--  --}}
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 col-start-1 row-span-1 col-span-1 ">
                       {{-- Vasos --}}
                ...
                {{-- uht  --}}
                <div
                    class="grid grid-cols-1 gap-2 h-full justify-center grid-rows-1 col-span-3 col-start-8  bg-white dark:bg-gray-900 p-2   rounded">
                    {{-- UHT --}}
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 col-start-1 row-span-1 col-span-1">
            ...
            {{-- 41 42 --}}
            <div
                class="col-span-1 col-start-5 bg-white dark:bg-gray-900 rounded-md p-2 row-span-2   row-start-2 ">
        ...
        <div class="row-span-4 col-span-2 grid grid-cols-1 grid-rows-4  col-start-13 ">
            {{-- ENV UX --}}
            <div class="col-span-1  bg-white dark:bg-gray-900 rounded-md p-2 row-span-2  ">
            ...
            {{-- env soy --}}
            <div class="col-span-1  bg-white dark:bg-gray-900 rounded-md p-2 row-span-1  row-start-4 ">
