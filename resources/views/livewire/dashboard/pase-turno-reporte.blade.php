<div class="">
    <div class="h-[calc(100vh-120px)] overflow-auto grid grid-cols-14 gap-2 text-2xs grid-rows-4 ">
        {{-- columna 1 --}}
        <div class="grid grid-cols-1 grid-rows-4 p-0 col-span-2 ">
            {{-- Recepcion --}}
            <div class="col-span-1 row-span-3 bg-white dark:bg-gray-900 rounded-md p-2 m-1">
                <div class="grid grid-rows-3 gap-2 h-full  justify-center">
                    {{-- R1 --}}
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 w-full aspect-square ">
                    ...
                    {{-- R2 --}}
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 aspect-square">
                        <div class=" flex  justify-between  ">
                            <div>
            ...
            {{-- tk nuevo --}}
            <div
                class="col-span-1 col-start-1 row-start-4 bg-white dark:bg-gray-900 rounded-md p-2  aspect-square m-1">
                {{-- TK NEW --}}

                <div class="grid gap-2 h-full justify-center ">
                    <div
                        class="p-2 h-full align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800  ">

                        <div class=" flex  justify-between  ">
                            <div>
                                <p class="text-lg">TK-NEW</p>
                            </div>
                            <div>
            ...
            {{-- columna 2 --}}
            <div class="grid grid-cols-5 grid-rows-4 p-0 col-span-10 col-start-3 ">
                {{-- mixes --}}
                <div class="col-span-4  row-span-1  bg-white dark:bg-gray-900 rounded-md p-2 m-1 ">


                    <div class="grid grid-cols-4 gap-2  justify-center grid-rows-1">
                        {{-- Mx1 --}}
                        <div
                            class="p-2  align-center bg-gray-100 rounded-xl flex flex-col justify-between dark:bg-gray-800 ">
                            <div class=" flex  justify-between  ">
                                <div>
                                    <p class="text-lg">R2</p>
                                </div>
                            ...
                            <div class="grid gap-2 justify-center">
                                <div class=" p-2 flex items-center justify-center">
                                    <div>
                                        ...
                                        <P>10083256 - 15 lotes</P>
                                        <p>ALIMENTO BEBIBLE A BASE DE EXTRACTO DE SOYA Y LECHE DE VACA FRUTILLA 120 ML -
                                            EL ALTO
                                        </p>
                                        <p>Preparacion:1-2</p>
                                    </div>
