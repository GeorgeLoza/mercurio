    ...
    <div class="flex justify-end items-center mb-2">
        ...
        <div>
            ...
            <button class="p-2 bg-green-500 rounded-lg"
                onclick="Livewire.dispatch('openModal', { component: 'dispositivo-temperatura.crear' })">
                ...
                @forelse ($temperaturas as $temperatura)
                    <tr
                        ...
                        <th scope="row"
                            ...
                            {{ \Carbon\Carbon::parse($temperatura->fecha_hora)->isoFormat('DD-MM-YY') }}
                        </th>
                        <td class="px-2 py-1" nowrap>
                            {{ $temperatura->dispositivosMedicion->codigo }}
                            {{ $temperatura->dispositivosMedicion->dispositivo }}
                        </td>

                        <td class="px-2 py-1">
                            {{ $temperatura->patron_1 }}
                        </td>
                        <td class="px-2 py-1">
                            {{ $temperatura->inst_1 }}
                        </td>
                        ...
                        <td class="flex items-center px-2 py-1 gap-2">
                            ...
                            <svg onclick="Livewire.dispatch('openModal', { component: 'dispositivoTemperatura.editar', arguments: { id: {{ $temperatura->id }} } })"
