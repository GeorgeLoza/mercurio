    ...
    <div class="flex justify-end items-center mb-2">
        ...
        <div>
            ...
            <button class="p-2 bg-green-500 rounded-lg"
                onclick="Livewire.dispatch('openModal', { component: 'dispositivo-crioscopo.crear' })">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg  overflow-y-auto h-[28rem] overflow-hidden">
        <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            ...
            <tbody class=" text-center">
                ...
                @forelse ($crioscopos as $crioscopo)
                    <tr
                        ...
                        <td class="flex items-center px-2 py-1 gap-2">
                            ...
                            <svg onclick="Livewire.dispatch('openModal', { component: 'dispositivoCrioscopo.editar', arguments: { id: {{ $crioscopo->id }} } })"
