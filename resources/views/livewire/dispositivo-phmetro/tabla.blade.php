    ...
    <div class="flex justify-end items-center mb-2">
        ...
        <div>
            ...
            <button class="p-2 bg-green-500 rounded-lg"
                onclick="Livewire.dispatch('openModal', { component: 'dispositivo-phmetro.crear' })">
        ...
        <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            <thead class="text-xs text-center text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-1 py-1 sticky top-0 bg-white dark:bg-gray-700" colspan="4">
                        Verificacion
                    </th>
                    <th scope="col" class="px-1 py-1 sticky top-0 bg-white dark:bg-gray-700" rowspan="2">
                        Requiere Ajuste
                ...
                @forelse ($phmetros as $phmetro)
                    <tr
                        ...
                        <td class="flex items-center px-2 py-1 gap-2">
                            ...
                            <svg onclick="Livewire.dispatch('openModal', { component: 'dispositivoPhmetro.editar', arguments: { id: {{ $phmetro->id }} } })"
