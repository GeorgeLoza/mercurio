<div>
    <div class="fixed z-50 top-4 right-4">
        @if ($show_success)
            <div id="alert-border-3"
                ...
                <button type="button" wire:click="cerrar_success"
        ...
        @if ($show_error)
            <div id="alert-border-2"
                ...
                <button type="button" wire:click="cerrar_error"
        ...
        @if ($show_warning)
            <div id="alert-border-4"
                ...
                <button type="button" wire:click="cerrar_warning"
    ...
    @script
        <script>
            document.addEventListener('auto-hide-toast', () => {
                setTimeout(() => {
                    @this.cerrar_success();
                    @this.cerrar_error();
                    @this.cerrar_warning();
