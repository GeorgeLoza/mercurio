        ...
        <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700" wire:click="sortBy('alias')">
                        alias
                    </th>
            ...
            <tbody class="">
                ...
                <tr
                    ...
                    <td class="flex items-center px-6 py-2 gap-2">
                        ...
                        <svg onclick="Livewire.dispatch('openModal', { component: 'origen.editar', arguments: { id: {{ $origen->id}} } })" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-blue-600 dark:fill-blue-500"
                            viewBox="0 0 512 512">
                            <path
                        ...
                        <svg onclick="Livewire.dispatch('openModal', { component: 'origen.eliminar', arguments: { id: {{ $origen->id}} } })" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-red-600 dark:fill-red-500"
                            viewBox="0 0 448 512">
                            <path
