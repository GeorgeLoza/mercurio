<div x-data="{ open: false }" class="relative inline-block text-left ">
    ...
    <button @click="open = !open"
            class="px-2 py-2 text-white font-semibold  bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  class="w-3 fill-white">
    ...
    <div x-show="open"
         ...
         class="absolute z-10 mt-2 w-60 bg-white rounded shadow-lg p-4 border border-gray-200 dark:bg-gray-800 text-black dark:text-white">
