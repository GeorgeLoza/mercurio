                ...
                @foreach ($calidades as $analisis)
                    ...
                    <tr
                        ...
                        <td class="flex items-center justify-center px-1 py-2 gap-1 " nowrap>
                            @if ($analisis->solicitudAnalisisLinea->estadoPlanta->etapa == 'Envasado' ||$analisis->solicitudAnalisisLinea->estadoPlanta->etapa == 'Pasteurizado' || $analisis->solicitudAnalisisLinea->estadoPlanta->etapa == 'Inoculación'  || auth()->user()->division->nombre == 'Calidad')
                                @if (now()->diffInMinutes($analisis->created_at) < 90)
