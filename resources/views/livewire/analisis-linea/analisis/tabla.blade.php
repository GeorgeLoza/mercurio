                    ...
                    <tr
                        ...
                        <td class="px-6 py-2" nowrap>
                            @if ($analisis->solicitudAnalisisLinea->estado == 'Pendiente')
                                <span class="flex items-center text-xs font-medium me-3"><span
                        ...
                        <td class="flex items-center justify-center px-1 py-2 gap-1 " nowrap>
                            ...
                            @if (now()->diffInMinutes($analisis->created_at) < 2400 ||
                                ...
                                <svg class="h-4 w-4"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M192 512C86 512 0 426 0 320C0 228.8 130.2 57.7 166.6 11.7C172.6 4.2 181.5 0 191.1 0l1.8 0c9.6 0 18.5 4.2 24.5 11.7C253.8 57.7 384 228.8 384 320c0 106-86 192-192 192zM96 336c0-8.8-7.2-16-16-16s-16 7.2-16 16c0 61.9 50.1 112 112 112c8.8 0 16-7.2 16-16s-7.2-16-16-16c-44.2 0-80-35.8-80-80z"/></svg>
                                <svg class="h-4 w-4"
                        ...
                        <td class="px-1 py-2 @if ($parametroLinea && $analisis->ph !== null) {{ $analisis->ph >= $parametroLinea->ph_min && $analisis->ph <= $parametroLinea->ph_max ? 'text-green-500' : 'text-red-500' }} @endif"
                            nowrap>
                            {{ $analisis->ph / 1 }}
                        </td>
                        ...
                        <td class="px-1 py-2 @if ($parametroLinea && $analisis->viscosidad !== null) {{ $analisis->viscosidad >= $parametroLinea->viscosidad_min && $analisis->viscosidad <= $parametroLinea->viscosidad_max ? 'text-green-500' : 'text-red-500' }} @endif"
                            nowrap>
                            {{ $analisis->viscosidad / 1 }}
                        </td>

                        <td class="px-1 py-2 @if ($parametroLinea && $analisis->densidad !== null) {{ $analisis->densidad >= $parametroLinea->densidad_min && $analisis->densidad <= $parametroLinea->densidad_max ? 'text-green-500' : 'text-red-500' }} @endif"
                            nowrap>
                            {{ $analisis->densidad / 1 }}
                        </td>
                        <td class="px-1 py-2" nowrap>
