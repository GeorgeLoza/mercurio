<div>
    ...
    <div>
        <form wire:submit="update" novalidate>
            ...
            @if (optional($extra->solicitudAnalisisLinea->estadoPlanta->etapa)->id != '2')
                <!--ph-->
                <div class=" px-3 mb-5">
                    <div class="relative z-0 w-full mb-5 group">
            ...
            @endif
            @if (optional($extra->solicitudAnalisisLinea->estadoPlanta->etapa)->id == '8')
                <!--densidad-->
            ...
            @if (optional($extra->solicitudAnalisisLinea->estadoPlanta->etapa)->id == '8')
                ...
                @if (auth()->user()->division->nombre == 'Produccion')
                    <!--peso-->
                    <div class=" px-3 mb-5">
                        <div class="relative z-0 w-full mb-5 group">
