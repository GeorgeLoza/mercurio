                ...
                <form novalidate wire:submit="dia2">
                    ...
                    @if (!in_array($data->detalleSolicitudPlanta->tipoMuestra->id, $excluidos))
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="number" step="0.01" name="aer_mes" id="aer_mes"
                                    wire:model.live="aer_mes"
                    ...
                    @if ($data->detalleSolicitudPlanta->tipoMuestra->id != 2)
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="number" step="0.01" name="col_tot" id="col_tot"
                                    wire:model.live="col_tot" placeholder=" "
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/3 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                <span class="w-1/3">
                                    @if ($col_tot >= 1000000)
                                        MNPC
                    ...
                    <h1>Observaciones</h1>
                    <input type="text" step="0.01" name="observaciones" id="aer_mes"
                        wire:model.live="observaciones"
                        class=" bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/3 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        placeholder=" ">
                    <button {{-- borra la siguiente linea si no funciona en externos --}} {{-- onclick="window.location.reload();" --}} type="submit"
            ...
            <div class="">
                ...
                <form novalidate wire:submit="dia5">
                    ...
                    <div>
                        ...
                        <label for="moh_lev" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Mohos
                            y
                    ...
                    @if (
                        ...
                        <div>
                            <input type="number" name="tipo" value="3" hidden>
                            <label for="moh_lev2"
                                class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Mohos
                                y
