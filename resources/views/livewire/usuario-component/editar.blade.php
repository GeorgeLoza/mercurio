                    ...
                    <div class="md:w-1/2 px-3 mb-5">
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <select id="rol" wire:model="rol"
                                ...
                                <option value="FQ" class="bg-gray-100 dark:bg-gray-800">Analista Fisicoquimico
                                </option>
                                <option value="MB" class="bg-gray-100 dark:bg-gray-800">Analista Microbiologico
                                </option>
                    ...
                    <div class="md:w-1/2 px-3 mb-5">
                        <div class="relative z-0 w-full mb-5 group">
                            <input wire:model='password' id="password" name="password" type="password" placeholder=" "
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                            <label for="password"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nueva contraseña</label>
                            @error('password')
                            <p class="text-red-500 text-xs">* {{$message}}</p>
                            @enderror
                        </div>
