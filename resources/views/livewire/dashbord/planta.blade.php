                    ...
                    <div data-popover id="tk41-analizar-popover" role="tooltip"
                        ...
                        @if (auth()->user()->role->rolModuloPermisos->where('modulo_id', 1)->where('permiso_id', 1)->isNotEmpty())
                            <div class="flex gap-2 px-3 py-2">
                                ...
                                <!--boton almacen-->
                                <button type="button"
                                    onclick="Livewire.dispatch('openModal', { component: 'estadoPlanta.almacen', arguments: { id: {{ $TK41->id }} } })"
                                    class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-orange-700 rounded-lg hover:bg-oange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
                    ...
                    <div data-popover id="tk42-analizar-popover" role="tooltip"
                        ...
                        @if (auth()->user()->role->rolModuloPermisos->where('modulo_id', 1)->where('permiso_id', 1)->isNotEmpty())
                            <div class="flex gap-2 px-3 py-2">
                                ...
                                <!--boton almacen-->
                                <button type="button"
                                    onclick="Livewire.dispatch('openModal', { component: 'estadoPlanta.almacen', arguments: { id: {{ $TK42->id }} } })"
                                    class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-orange-700 rounded-lg hover:bg-oange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
            ...
            @if ($HTST_1A)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_1A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_1A->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_1A->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_1A->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_1A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_1B)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_1B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_1B->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_1B->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_1B->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_1B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_1C)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_1C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_1C->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_1C->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_1C->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_1C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_2A)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_2A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_2A->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_2A->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_2A->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_2A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_2B)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_2B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_2B->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_2B->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_2B->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_2B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_2C)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_2C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_2C->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_2C->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_2C->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_2C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_3A)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_3A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_3A->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_3A->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_3A->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_3A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_3B)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_3B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_3B->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_3B->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_3B->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_3B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_3C)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_3C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_3C->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_3C->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_3C->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_3C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_4A)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_4A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_4A->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_4A->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_4A->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_4A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_4B)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_4B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_4B->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_4B->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_4B->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_4B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_4C)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_4C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_4C->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_4C->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_4C->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_4C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_5A)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_5A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_5A->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_5A->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_5A->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_5A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_5B)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_5B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_5B->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_5B->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_5B->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_5B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($HTST_5C)
                ...
                <div class="px-3 py-2">
                    @if (count($HTST_5C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Estado Análisis</Span>: {{ $ultimo_HTST_5C->estado }}
                        </p> -
                        {{ \Carbon\Carbon::parse($ultimo_HTST_5C->tiempo)->isoFormat('HH:mm') }}
                        <p><Span class="inline-block w-32">Temp.</Span>:
                            {{ $ultimo_HTST_5C->analisisLinea->temperatura / 1 }} [°C]</p>
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_HTST_5C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
            ...
            @if ($UHT_1A)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_1A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_1A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_1A->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_1A->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_1B)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_1B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_1B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_1B->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_1B->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_1C)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_1C->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_1C->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_1C->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_1C->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_2A)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_2A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_2A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_2A->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_2A->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_2B)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_2B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_2B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_2B->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_2B->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_3A)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_3A->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_3A->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_3A->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_3A->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($UHT_3B)
                ...
                <div class="px-3 py-2">
                    @if (count($UHT_3B->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_UHT_3B->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_UHT_3B->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_UHT_3B->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    @endif
                </div>
            ...
            @if ($V1)
                ...
                <div class="px-3 py-2">
                    @if (count($V1->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_V1->analisisLinea->acidez / 1 }}[%]
                        </p>
            ...
            @if ($V2)
                ...
                <div class="px-3 py-2">
                    @if (count($V2->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_V2->analisisLinea->acidez / 1 }}[%]
                        </p>
            ...
            @if ($V3)
                ...
                <div class="px-3 py-2">
                    @if (count($V3->solicitudAnalisisLinea) > 0)
                        ...
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_V3->analisisLinea->acidez / 1 }}[%]
                        </p>
            ...
            @if ($araña)
                ...
                @if (count($araña->solicitudAnalisisLinea) > 0)
                    <div class="px-3 py-2">
                        ...
                        <p><Span class="inline-block w-32">pH</Span>: {{ $ultimo_araña->analisisLinea->ph / 1 }}
                        </p>
                        <p><Span class="inline-block w-32">Ac.</Span>:
                            {{ $ultimo_araña->analisisLinea->acidez / 1 }}[%]
                        </p>
                        <p><Span class="inline-block w-32">Sólidos</Span>:
                            {{ $ultimo_araña->analisisLinea->brix / 1 }}
                            [°Bx]
                        </p>
                    </div>
                @endif
