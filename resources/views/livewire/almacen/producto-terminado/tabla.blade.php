        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class=" fl0ex gap-2 px-6 py-3 sticky top-0 bg-white dark:bg-gray-700">
                        opciones
            ...
            <tbody class="">
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <th class="p-1">
                        <input type="number" wire:model.live='f_alias' placeholder="Filtrar por Cantidad"
                            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                </tr>
                @endif
                ...
                <tr
                    ...
                    <td class="flex items-center px-6 py-2 gap-2">
                        @if(now()->diffInMinutes($almacen->created_at)<240)
                        <svg onclick="Livewire.dispatch('openModal', { component: 'almacen.productoTerminado.editar', arguments: { id: {{ $almacen->id}} } })"
                        ...
                        @if(now()->diffInMinutes($almacen->created_at)<240) 
                        <svg onclick="Livewire.dispatch('openModal', { component: 'almacen.productoTerminado.eliminar', arguments: { id: {{ $almacen->id}} } })"
