        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            <thead class="text-2xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('producto_codigo')">
                        Código
                    </th>

                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('producto_nombre')">
                        Nombre
                    </th>
                    ...
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('etapa_nombre')">
                        etapa
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('temperatura_min')">
                        temperatura_min
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('temperatura_max')">
                        temperatura_max
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('ph_min')">
                        ph_min
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('ph_max')">
                        ph_max
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('acidez_min')">
                        acidez_min
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('acidez_max')">
                        acidez_max
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('brix_min')">
                        brix_min
                    </th>

                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('brix_max')">
                        brix_max
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('viscosidad_min')">
                        viscosidad_min
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('viscosidad_max')">
                        viscosidad_max
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('densidad_min')">
                        densidad_min
                    </th>
                    <th scope="col" class="px-6 py-3 sticky top-0 bg-white dark:bg-gray-700"
                        wire:click="sortBy('densidad_max')">
                        densidad_max
                    </th>
            ...
            <tbody class="text-xs">
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <th class="p-1">
                        <input type="text" wire:model.live='f_categoria' placeholder="Filtrar por categoria"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                    <th class="p-1">
                    ...
                    <th class="p-1">
                        <input type="text" wire:model.live='f_temperatura_min'
                            placeholder="Filtrar por temperatura minima"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>

                    <th class="p-1">
                        <input type="text" wire:model.live='f_temperatura_max'
                            placeholder="Filtrar por temperatura maxima"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                    ...
                    <th class="p-1">
                        <input type="text" wire:model.live='f_acidez_min'
                            placeholder="Filtrar por temperatura acidez_min"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>

                    <th class="p-1">
                        <input type="text" wire:model.live='f_acidez_max'
                            placeholder="Filtrar por temperatura acidez_max"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>

                    <th class="p-1">
                        <input type="text" wire:model.live='f_brix_min'
                            placeholder="Filtrar por temperatura brix_min"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                    <th class="p-1">
                        <input type="text" wire:model.live='f_brix_max'
                            placeholder="Filtrar por temperatura brix_max"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>

                    <th class="p-1">
                        <input type="text" wire:model.live='f_densidad_min'
                            placeholder="Filtrar por temperatura densidad_min"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>

                    <th class="p-1">
                        <input type="text" wire:model.live='f_densidad_max'
                            placeholder="Filtrar por temperatura densidad_max"
                            class="block w-full p-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-2xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                    <th class="p-1">
                ...
                @foreach ($parametro_lineas as $parametro_linea)
                    <tr
                        ...
                        <td class="px-6 py-2" nowrap>
                            {{ $parametro_linea->producto->categoriaProducto->nombre }}
                        </td>
                        <td class="px-6 py-2" nowrap>
                            {{ optional($parametro_linea->etapa)->nombre }}
                        </td>
                        ...
                        <td class="flex items-center px-6 py-2 gap-2">
                            @if (auth()->user()->role->rolModuloPermisos->where('modulo_id', 9)->where('permiso_id', 3)->isNotEmpty())
                                <svg onclick="Livewire.dispatch('openModal', { component: 'parametro.parametro-linea.editar', arguments: { id: {{ $parametro_linea->id }} } })"
                            ...
                            @if (auth()->user()->role->rolModuloPermisos->where('modulo_id', 9)->where('permiso_id', 4)->isNotEmpty())
                                @if (now()->diffInMinutes($parametro_linea->created_at) < 120)
                                    <svg onclick="Livewire.dispatch('openModal', { component: 'parametro.parametro-linea.eliminar', arguments: { id: {{ $parametro_linea->id }} } })"
                                        xmlns="http://www.w3.org/2000/svg"
