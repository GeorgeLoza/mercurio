        ...
        <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            ...
            <tbody class="">
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <th class="p-1">
                        <input type="text" wire:model.live='f_categoriaProducto' placeholder="Filtrar por Categoría"
                            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </th>
                    <th class="p-1">
                ...
                <tr
                    ...
                    <td class="px-2 py-1" nowrap>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-green-600 h-5 w-5" viewBox="0 0 512 512">
                        ...
                        @else
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-yellow-600 h-5 w-5" viewBox="0 0 512 512">
                            <path
                    ...
                    <td class="flex items-center px-2 py-1 gap-2">
                        ...
                        @endif
                        @if(in_array(auth()->user()->rol, ['Admi','Jef']))
                        @if(now()->diffInMinutes($producto->created_at)<120) <svg
                            onclick="Livewire.dispatch('openModal', { component: 'producto.eliminar', arguments: { id: {{ $producto->id}} } })"
