                ...
                @foreach ($estados as $estado)
                    <tr
                        ...
                        <td class="flex items-center px-6 py-2 gap-2">
                            @if ((now()->diffInMinutes($estado->created_at) < 90 && auth()->user()->id == $estado->user->id)|| auth()->user()->role->rolModuloPermisos->where('modulo_id', 3)->where('permiso_id', 3)->isNotEmpty())
                            ...
                            @endif
                            @if ((now()->diffInMinutes($estado->created_at) < 90 && auth()->user()->id == $estado->user->id)|| auth()->user()->role->rolModuloPermisos->where('modulo_id', 3)->where('permiso_id', 4)->isNotEmpty())
