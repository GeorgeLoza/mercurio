<div >
    ...
    @if ($id2 == 1)
        <div>
            ...
            <input wire:model="col" type="number" min="0" class="w-full border rounded p-2 mb-2 dark:bg-slate-800 border-gray-500">
            @error('col')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div>
        ...
        <input wire:model="observaciones" type="text" min="0" class="w-full border rounded p-2 mb-2 dark:bg-slate-800 border-gray-500">
        @error('observaciones')
            <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
