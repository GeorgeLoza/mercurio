<div>
    <form wire:submit.prevent="save({{ $est ? 1 : 0 }})" novalidate>
        ...
        <div class="flex items-center justify-between p-4 md:p-3 border-b rounded-t dark:border-gray-600">
            ...
            <button type="button" wire:click="cerrar" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div>
            ...
            <button type="button" wire:click="addDetalle" class="mt-2 bg-blue-500 text-white rounded-md px-2 py-1">Agregar Detalle</button>
        ...
        <div class="mt-4">
            <button type="submit" class="w-full bg-green-600 text-white rounded-md px-4 py-2">{{ $id ? 'Actualizar' : 'Crear' }}</button>
        </div>

        <div wire:loading>
            <div class="fixed inset-0 flex items-center justify-center bg-gray-50 bg-opacity-75 dark:bg-gray-800 dark:bg-opacity-75 z-50">
                <div role="status">
