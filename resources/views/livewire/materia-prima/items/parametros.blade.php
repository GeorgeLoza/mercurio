        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg flex justify-between">
            <div class="w-1/3 p-4 border-r">
                ...
                <div class="mb-4">
                    ...
                    <select wire:model.live="selectedCategoria" class="border px-2 py-1 w-full">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" wire:model.live="filter" class="border px-2 py-1 w-full"
                ...
                <div class="mb-4">
                    ...
                    <select wire:model.live="selectedItem" class="border px-2 py-1 w-full">
                ...
                @if ($selectedItem)
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="itemData.nombre" class="border px-2 py-1 w-full">
                        </div>

                        <!-- Código -->
                        <div>
                            <label class="block mb-1">Código</label>
                            <input type="text" wire:model="itemData.codigo" class="border px-2 py-1 w-full">
                        </div>

                        <!-- Unidad -->
                        <div>
                            <label class="block mb-1">Unidad</label>
                            <select wire:model="itemData.unidad_id" class="border px-2 py-1 w-full">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3  gap-4 mb-1">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="itemData.descripcion" class="border px-2 py-1 w-full">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="itemData.Nivel_dilucion" class="border px-2 py-1 w-full">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.nca_min" class="border px-2 py-1 w-full">
                            </div>
                            <div>
                                <label class="block mb-1">NCA Máx</label>
                                <input type="number" wire:model="itemData.nca_max" class="border px-2 py-1 w-full">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.temp_min" class="border px-2 py-1 w-full">
                            </div>
                            <div>
                                <label class="block mb-1">Temp Máx</label>
                                <input type="number" wire:model="itemData.temp_max" class="border px-2 py-1 w-full">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.ph_min" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                            <div>
                                <label class="block mb-1">pH Máx</label>
                                <input type="number" wire:model="itemData.ph_max" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.solidos_min" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                            <div>
                                <label class="block mb-1">Sólidos Máx</label>
                                <input type="number" wire:model="itemData.solidos_max" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.acidez_min" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                            <div>
                                <label class="block mb-1">Acidez Máx</label>
                                <input type="number" wire:model="itemData.acidez_max" class="border px-2 py-1 w-full"
                                    step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="itemData.densidad_min"
                                    class="border px-2 py-1 w-full" step="0.01">
                            </div>
                            <div>
                        ...
                        <div>
                            <label class="block mb-1">Organoléptica</label>
                                <input type="text" wire:model="itemData.organoleptica" class="border px-2 py-1 w-full">
