                ...
                <div class="flex gap-1 text-sm ">
                    ...
                    <div class=" md:hidden ">
                        {{ substr(auth()->user()->nombre, 0, 1) .
                            ...
                            substr(explode(' ', auth()->user()->apellido)[1] ?? '', 0, 1) }}
                    </div>
