...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/app-383fa538.css') }}">
                ...
                @if (auth()->user()->role->rolModuloPermisos->where('modulo_id', 32)->where('permiso_id', 2)->isNotEmpty())
                    <li>
                        <a href="{{ route('seguimiento.index') }}"
                            ...
                            <span class="ms-3">Seguimiento</span>
                        </a>
                    </li>
                @endif
 <!--dESINFECCION-->
