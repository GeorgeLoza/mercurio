...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/app-62923df9.css') }}">
                    ...
                    <div class="flex items-center">
                        <div><button data-popover-target="popover-description" data-popover-placement="bottom-end"
                            ...
                            <div data-popover id="popover-description" role="tooltip"
                                class="p-4 absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">

                                <div class="border-b border-gray-200 dark:border-gray-600 mb-2 pb-2">
                                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Para soporte, o reporte de
                                        fallo
                                        comunicarse con los siguientes numeros</h3>
