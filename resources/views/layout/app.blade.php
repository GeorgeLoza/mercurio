...
<body class="bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-300 min-h-screen">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-56 h-screen pt-12 transition-transform -translate-x-full bg-white sm:translate-x-0 dark:bg-gray-800  shadow-md dark:shadow-gray-600"
        aria-label="Sidebar">
