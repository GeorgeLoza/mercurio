                        ...
                        <tr>
                            ...
                            <th nowrap>
                                @if ($variables->destinoSolucion == null)
                                    Almacen Laboratorio
                                @else
                                    {{ $variables->destinoSolucion->descripcion }}
                                @endif
                            ...
                            <th>
                                @if ($variables->usuarioAutorizante)
                                    {{ $variables->usuarioAutorizante->codigo }}
                                @endif
                            </th>
                            <th>
                                @if ($variables->usuarioEntregante)
                                    {{ $variables->usuarioEntregante->codigo }}
                                @endif
                            </th>
