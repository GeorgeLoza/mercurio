...
@section('contenido')
    ...
    @if (auth()->user()->rol == 'Acp'  || auth()->user()->rol == 'Ext')
    ...
    @if (auth()->user()->division->nombre == 'ERROR' || auth()->user()->division->nombre == 'Admi')
        <div data-dial-init class="fixed end-6 bottom-6 group">
            <div id="speed-dial-menu-default" class="flex flex-col items-center hidden mb-4 space-y-2">
                ...
                <button type="button" onclick="Livewire.dispatch('openModal', { component: 'estadoPlanta.crear' })"
                    data-tooltip-target="tooltip-tanque" data-tooltip-placement="left"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                        ...
                        <path transform="scale(0.8 0.8)"
                            d="M237.109 145.655L217.461 145.691C214.08 145.703 209.998 146.151 206.721 145.446L206.25 145.337C168.98 137.037 169.336 81.1106 208.802 74.7749C215.208 73.7465 222.256 74.3548 228.766 74.3554L403.742 74.3688C408.358 74.0686 413.195 74.352 417.832 74.353L427.229 74.3635C471.968 74.4766 474.175 139.192 434.637 145.NULL.196 145.687 429.594 145.595 427.128 145.611L237.109 145.655Z" />
                        <path transform="scale(0.8 0.8)"
                            d="M442.37 551.275L192.626 551.259C188.48 551.252 182.971 551.741 179.063 550.408L176.796 549.7NULL.703 544.NULL 143.897 529.168 138.837 510.345C135.986 499.737 137.4NULL 488.224 137.426 477.NULL.428 260.547C137.481 248.452 143.304 241.502 150.055 2NULL.823L193.12 168.771C195.019 166.123 196.779 163.177 199.225 161.002L441.895 161.046C445.811 162.84 449.763 170.636 452.225 174.202L490.248 229.658C496.708 239.148 504.17 247.972 504.234 260.011L504.179 497.862C504.069 526.62 483.354 548.942 454.4 551.147C450.441 551.449 446.345 551.277 442.37 551.275Z" />
                    </svg>
        ...
        <div id="tooltip-print" role="tooltip"
            ...
            <div class="tooltip-arrow" data-popper-arrow></div>
                ...
                <button type="button"
                    onclick="Livewire.dispatch('openModal', { component: 'estadoPlanta.crearEnvasadora' })"
